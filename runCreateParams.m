...
SParams = cell(3, 1);
% 2019年4月8日15:42:01
[ SParams{1} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:0.03:5)', (0:0.01:1)', linear0);
[ SParams{2} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:0.03:5)', (0:0.01:1)', poly0);
[ SParams{3} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:0.03:5)', (0:0.01:1)', rbf0);
...
%         RMTL
        struct('ID', 'RMTL_L1', 'Name', 'RMTL', 'lambda1', MU, 'lambda2', mu, 'kernel', k0);...
        struct('ID', 'SSRL1_RMTL', 'Name', 'SSR_RMTL', 'lambda1', MU, 'lambda2', mu, 'kernel', k0);...
        struct('ID', 'RMTL_L2', 'Name', 'RMTL', 'lambda2', MU, 'lambda1', mu, 'kernel', k0);...
        struct('ID', 'SSRL2_RMTL', 'Name', 'SSR_RMTL', 'lambda2', MU, 'lambda1', mu, 'kernel', k0);...
        struct('ID', 'RMTL_P', 'Name', 'RMTL', 'kernel', rbf, 'lambda1', mu, 'lambda2', 1);...
        struct('ID', 'SSRP_RMTL', 'Name', 'SSR_RMTL', 'kernel', rbf, 'lambda1', mu, 'lambda2', 1);...
%         IRMTL
...
%         DMTSVM
        struct('ID', 'DMTSVMA_C', 'Name', 'SSR_DMTSVMA', 'C1', C, 'rho', nv, 'kernel', k0);...
        struct('ID', 'SSRC_DMTSVMA', 'Name', 'SSR_DMTSVM', 'C1', C, 'rho', nv, 'kernel', k0);...
        struct('ID', 'DMTSVMA_M', 'Name', 'SSR_DMTSVMA', 'rho', NV, 'C1', c, 'kernel', k0);...
        struct('ID', 'SSRM_DMTSVMA', 'Name', 'SSR_DMTSVM', 'rho', NV, 'C1', c, 'kernel', k0);...
%         LSMTWSVM
%         struct('ID', 'DMTSVM_C', 'Name', 'DMTSVM', 'C1', C, 'rho', mu, 'kernel', k0);...
%         struct('ID', 'DMTSVM_M', 'Name', 'DMTSVM', 'rho', MU, 'C1', c, 'kernel', k0);...
%         struct('ID', 'LSTWSVM', 'Name', 'LSTWSVM', 'C1', C, 'kernel', k0);...
%         struct('ID', 'MTLS_TWSVM', 'Name', 'MTLS_TWSVM', 'C1', C, 'rho', MU, 'kernel', k0);...
%         struct('ID', 'DMTSVM_M', 'Name', 'DMTSVM', 'rho', MU, 'C1', C, 'kernel', k0);...
%         struct('ID', 'SSRM_DMTSVM', 'Name', 'SSR_DMTSVM', 'rho', MU, 'C1', C, 'kernel', k0);...
    };
end