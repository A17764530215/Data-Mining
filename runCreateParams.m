...
SParams = {
%     lambda1
%     struct('ID', 'RMTL_L1', 'Name', 'RMTL', 'lambda1', lambda, 'lambda2', lambda, 'kernel', kernel0);...
%     struct('ID', 'SSRL1_RMTL', 'Name', 'SSR_RMTL', 'lambda1', lambda, 'lambda2', lambda, 'kernel', kernel0);...
%     lambda2
%     struct('ID', 'RMTL_L2', 'Name', 'RMTL', 'lambda2', lambda, 'lambda1', lambda, 'kernel', kernel0);...
%     struct('ID', 'SSRL2_RMTL', 'Name', 'SSR_RMTL', 'lambda2', lambda, 'lambda1', lambda, 'kernel', kernel0);...
%     C
