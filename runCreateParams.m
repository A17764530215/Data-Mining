...
SParams = cell(3, 1);
% 2019年4月8日15:42:01
[ SParams{1} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:0.01:5)', (0:0.004:1)', linear0);
[ SParams{2} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:0.01:5)', (0:0.004:1)', poly0);
[ SParams{3} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:0.01:5)', (0:0.004:1)', rbf0);
...
%         RMTL
        struct('ID', 'RMTL_L1', 'Name', 'RMTL', 'lambda1', MU, 'lambda2', 1, 'kernel', k0);...
        struct('ID', 'SSRL1_RMTL', 'Name', 'SSR_RMTL', 'lambda1', MU, 'lambda2', 1, 'kernel', k0);...
        struct('ID', 'RMTL_L2', 'Name', 'RMTL', 'lambda2', MU, 'lambda1', 1, 'kernel', k0);...
        struct('ID', 'SSRL2_RMTL', 'Name', 'SSR_RMTL', 'lambda2', MU, 'lambda1', 1, 'kernel', k0);...
        struct('ID', 'RMTL_P', 'Name', 'RMTL', 'kernel', rbf, 'lambda1', 1, 'lambda2', 1);...
        struct('ID', 'SSRP_RMTL', 'Name', 'SSR_RMTL', 'kernel', rbf, 'lambda1', 1, 'lambda2', 1);...
%         IRMTL
...
%         struct('ID', 'SSRC_DMTSVM', 'Name', 'SSR_DMTSVM', 'C1', C, 'rho', mu, 'kernel', k0);...
%         struct('ID', 'DMTSVM_M', 'Name', 'DMTSVM', 'rho', MU, 'C1', c, 'kernel', k0);...
%         struct('ID', 'SSRM_DMTSVM', 'Name', 'SSR_DMTSVM', 'rho', MU, 'C1', c, 'kernel', k0);...
%         struct('ID', 'DMTSVM_P', 'Name', 'DMTSVM', 'kernel', rbf, 'C1', c, 'rho', 0.5);...
%         struct('ID', 'SSRP_DMTSVM', 'Name', 'SSR_DMTSVM', 'kernel', rbf, 'C1', c, 'rho', 1);...
%         LSMTWSVM
