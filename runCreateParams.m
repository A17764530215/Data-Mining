...
p1 = 2.^(-3:8)'; % 核函数参数
kernel = struct('kernel', 'rbf', 'p1', p1);
kernel0 = struct('kernel', 'rbf', 'p1', p1(9));
lambda = 2.^(1:0.2:8)';
c = 2.^(1:0.1:5)';
mu = 2.^(1:0.1:5)';
SParams = {
    struct('ID', 'RMTL', 'Name', 'RMTL', 'lambda1', lambda, 'lambda2', lambda, 'kernel', kernel0);...
    struct('ID', 'SSR_RMTL', 'Name', 'SSR_RMTL', 'lambda1', lambda, 'lambda2', lambda, 'kernel', kernel0);...
    % C
    struct('ID', 'IRMTL_C', 'Name', 'IRMTL', 'C', c, 'mu', mu, 'kernel', kernel0);...
    struct('ID', 'IRMTL_SSRC', 'Name', 'SSR_IRMTL', 'C', c, 'mu', mu, 'kernel', kernel0);...
    % MU
    struct('ID', 'IRMTL_M', 'Name', 'IRMTL', 'mu', mu, 'C', c, 'kernel', kernel0);...
    struct('ID', 'IRMTL_SSRM', 'Name', 'SSR_IRMTL', 'mu', mu, 'C', c, 'kernel', kernel0);...
};
% 保存参数表
