...
function [ CParams ] = PackCParams(C, RHO, MU, ETA, P, RATE, kernel)
    CParams = {
        ...
        struct('Name', 'MTLS_TWSVM', 'C', C, 'rho', RHO, 'kernel', kernel, 'smw', true);...
...
%         CRMTL
        ...
        struct('ID', 'SSRC_CRMTL_DCDM0', 'Name', 'SSR_CRMTL', 'C', C, 'mu', nv, 'kernel', k0);...
        struct('ID', 'SSRC_CRMTL_DCDM1', 'Name', 'SSR_CRMTL', 'C', C, 'mu', nv, 'dcdm', dcdm, 'kernel', k0);...
    };
end