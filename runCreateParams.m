...
% 2019年4月2日23:04:28
[ SParams{1} ] = PackSParams(2.^(0:0.05:5)', 2.^(-5:5)', linear0);
[ SParams{2} ] = PackSParams(2.^(0:0.05:5)', 2.^(-5:5)', poly0);
[ SParams{3} ] = PackSParams(2.^(0:0.05:5)', 2.^(-5:5)', rbf0);
...
%         SVM
        ...
        struct('ID', 'DMTSVM', 'Name', 'DMTSVM', 'C1', C, 'rho', MU, 'kernel', kernel);...
%         MTSVM
...
%         struct('ID', 'CRMTL_M', 'Name', 'CRMTL', 'mu', MU, 'C', C, 'kernel', kernel);...
%         struct('ID', 'SSRM_CRMTL', 'Name', 'SSR_CRMTL', 'mu', MU, 'C', C, 'kernel', kernel);...
%         IRMTL
