...
SParams = cell(3, 1);
% 2019年4月8日15:42:01
[ SParams{1} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:5)', (0:0.1:1)', linear0);
[ SParams{2} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:5)', (0:0.1:1)', poly0);
[ SParams{3} ] = PackSParams(2.^(0:0.03:5)', 2.^(-5:5)', (0:0.1:1)', rbf0);
...
%% 安全筛选参数
function [ SParams ] = PackSParams(C, MU, NV, kernel)
    SParams = {
%         SVM
...
%         CRMTL
        struct('ID', 'CRMTL_C', 'Name', 'CRMTL', 'C', C, 'mu', NV, 'kernel', kernel);...
        struct('ID', 'SSRC_CRMTL', 'Name', 'SSR_CRMTL', 'C', C, 'mu', NV, 'kernel', kernel);...
%         struct('ID', 'CRMTL_M', 'Name', 'CRMTL', 'mu', NV, 'C', C, 'kernel', kernel);...
%         struct('ID', 'SSRM_CRMTL', 'Name', 'SSR_CRMTL', 'mu', NV, 'C', C, 'kernel', kernel);...
%         IRMTL
        struct('ID', 'IRMTL_C', 'Name', 'IRMTL', 'C', C, 'mu', MU, 'kernel', kernel);...
        struct('ID', 'SSRC_IRMTL', 'Name', 'SSR_IRMTL', 'C', C, 'mu', MU, 'kernel', kernel);...
%         DMTSVM
%         struct('ID', 'DMTSVM_C', 'Name', 'DMTSVM', 'C1', C, 'rho', MU, 'kernel', kernel);...
%         struct('ID', 'SSRC_DMTSVM', 'Name', 'SSR_DMTSVM', 'C1', C, 'rho', MU, 'kernel', kernel);...
%         LSMTWSVM
%         struct('ID', 'LSTWSVM', 'Name', 'LSTWSVM', 'C1', C, 'kernel', kernel);...
%         struct('ID', 'MTLS_TWSVM', 'Name', 'MTLS_TWSVM', 'C1', C, 'rho', MU, 'kernel', kernel);...
%         struct('ID', 'IRMTL_M', 'Name', 'IRMTL', 'mu', MU, 'C', C, 'kernel', kernel);...
%         struct('ID', 'SSRM_IRMTL', 'Name', 'SSR_IRMTL', 'mu', MU, 'C', C, 'kernel', kernel);...
%         struct('ID', 'DMTSVM_M', 'Name', 'DMTSVM', 'rho', MU, 'C1', C, 'kernel', kernel);...
%         struct('ID', 'SSRM_DMTSVM', 'Name', 'SSR_DMTSVM', 'rho', MU, 'C1', C, 'kernel', kernel);...
    };
end