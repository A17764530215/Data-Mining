...
%         DMTSVM
        struct('ID', 'DMTSVMA_C', 'Name', 'SSR_DMTSVMA', 'C1', C, 'rho', mu, 'kernel', k0);...
        struct('ID', 'SSRC_DMTSVMA', 'Name', 'SSR_DMTSVM', 'C1', C, 'rho', mu, 'kernel', k0);...
        struct('ID', 'DMTSVMA_M', 'Name', 'SSR_DMTSVMA', 'rho', MU, 'C1', c, 'kernel', k0);...
        struct('ID', 'SSRM_DMTSVMA', 'Name', 'SSR_DMTSVM', 'rho', MU, 'C1', c, 'kernel', k0);...
%         LSMTWSVM
