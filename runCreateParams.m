...
%     struct('Name', 'RMTL', 'lambda1', C, 'lambda2', C, 'kernel', kernel);...
%     struct('Name', 'SSR_RMTL', 'lambda1', C, 'lambda2', C, 'kernel', kernel);...
    struct('Name', 'IRMTL', 'C', c, 'mu', RHO, 'kernel', kernel);...
    struct('Name', 'SSR_IRMTL', 'C', c, 'mu', RHO, 'kernel', kernel);...
